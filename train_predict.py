...
if __name__=="__main__":
	...
	if mode=="how_to_run":
		...
		if args.data_dir != "":
			...
			############################################
			test_data = "../experiment/cantonese/dnn_tone_test_data/all_data/test_feat"
			test_label = "../experiment/cantonese/dnn_tone_test_data/all_data/test_f0"
			test_map = "../experiment/cantonese/dnn_tone_test_data/all_data/test_syllable_map"
			############################################
		...
		if config.update_data:
			...
			############################################
			collect_utt_data("./test_data_f0",test_map,"./lstm_data/test","../experiment/cantonese/txt.done.data.test_word",word_index)
			############################################
			...
			############################################
			append_pos_to_feature("./lstm_data/test","../experiment/cantonese/can_pos",pos_dic)
			############################################
			# pos_num = 32
			############################################
			...
			############################################
			append_phrase_to_feature("./lstm_data/test","../experiment/cantonese/dnn_tone_test_data/phrase_dir/phrase_syllable")
			############################################
			...
			############################################
			append_dep_to_feature("./lstm_data/test","../experiment/cantonese/can_dep",dep_dic)
			############################################
			exit()
			############################################
